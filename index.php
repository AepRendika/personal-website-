...
<body class="bg-green-300 text-gray-800 font-sans">
<!-- Header -->
<header class="bg-greem-900 text-white text-center p-6 text-2xl font-bold">
Personal Web | aep rendika
</header>
<!-- Navigation -->
...
&copy; <?php echo date('Y'); ?> | aep rendika
</footer>
</body>
